//
//  ReusableKeyboardObservingView.swift
//  Rattit
//
...
class ReusableKeyboardObservingView: UIView {
    ...
    private func keyboardDidChangeFrame(frame: CGRect) {
        ...
        NotificationCenter.default.post(name: NSNotification.Name(rawValue: ContentOperationNotificationName.keyboardFrameDidChange.rawValue), object: nil, userInfo: userInfo)
    }
