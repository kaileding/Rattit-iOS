//
//  MomentCommentReplyTableViewCell.swift
//  Rattit
//
...
class MomentCommentReplyTableViewCell: UITableViewCell {
...
extension MomentCommentReplyTableViewCell {
    func avatarImagePressed() {
        print("MomentCommentReplyTableViewCell.avatarImagePressed() func.")
    }
    
    func photoTapRecognized() {
        print("MomentCommentReplyTableViewCell.imageTapRecognized() func.")
    }
}
